...
import share.photo.network.UserLikePhotoPhotoListGet;
 ...
 * 
 */
public class UserLikePhotosActivity extends Activity implements
		INetworkListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(PhoneDisplayAdapter.computeLayout(this,
				R.layout.activity_user_like_photos));
	...
	private void refresh()
	{
		...
		new UserLikePhotoPhotoListGet().getUserLikePhotos(mUserId,
				mCurrentPage, mPageSize, this);
	}

	private void initLayout()
	{
		mWaterfallscroll = (LazyScrollView) findViewById(R.id.user_like_photos_waterfall_scroll);
		...
		mWaterfallscroll.setOnScrollListener(new OnScrollListener()
		{
			...
			public void onBottom()
			{
				...
				if (mCurrentPage < mCountPage)
				{
					++mCurrentPage;
					new UserLikePhotoPhotoListGet().getUserLikePhotos(mUserId,
							mCurrentPage, mPageSize, UserLikePhotosActivity.this);
				}
			}
		...
		mWaterfallContainer = (LinearLayout) this
				.findViewById(R.id.user_like_photos_waterfall_container);
	...
	public void onReslut(Object result)
	{
		...
		if (result instanceof PhotoListInfoBean)
		{
			...
			List<PhotoBean> list = mPhotoListInfoBean.getData().getList();
	...
	public void onClick(View v)
	{
		switch (v.getId())
		{
		case R.id.user_like_photos_img_back:
			finish();
			break;
