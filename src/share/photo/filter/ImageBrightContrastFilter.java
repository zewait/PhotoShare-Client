 ...
 * 
 */
public class ImageBrightContrastFilter implements ImageFilterInterface
{
	...
	public ImageBrightContrastFilter(Bitmap bmp)
	{
		image = new ImageData(bmp);
	}

	public ImageBrightContrastFilter(ImageData image)
	{
		this.image = image;
	}
