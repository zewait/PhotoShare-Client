 ...
 * 
 */
public class ImageGaussianBlurFilter implements ImageFilterInterface
{
	...
	public ImageGaussianBlurFilter(Bitmap bmp)
	{
	...
	void ApplyPass(float[] pixels, int width, int height, float b0, float b1,
	...
	public Bitmap imageProcess()
	{
		...
		for (int i = 0; i < height; i++)
		{
			...
			{
				int pos = (num + j) * 3;
				image.setPixelColor(j, i, (int) (imageArray[pos] * 255f),
						(int) (imageArray[pos + 1] * 255f),
